...
Dispatch pricing replaces new Carrier Network signups: Basic USD 300/truck/week or 5%, Standard USD 500/truck/week or 7%, Premium USD 700/truck/week or 10%. Customers select one method; weekly subscriptions carry no percentage surcharge. App access is included. Onboarding remains USD 150 once per fleet. The published percentage basis is collected line-haul revenue on Alphaway-dispatched loads, excluding fuel surcharges, detention, TONU, lumper fees and reimbursements.

Percentage selections persist as pending_review requests, scoped to the authenticated company and visible to staff. They do not activate a contract or create a Stripe payment. Staff must confirm a signed agreement and service capacity, reconcile collected revenue, issue invoices, and record onboarding payment before activating percentage service. Automated revenue import and percentage collection remain unimplemented. Public intake requests preserve the package, billing method and terms version and are visible in Admin. Existing legacy subscription events remain supported.
